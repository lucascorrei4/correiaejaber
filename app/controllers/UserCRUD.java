...
public class UserCRUD extends CRUD {
	...
	public static void list(int page, String search, String searchFields, String orderBy, String order) {
		redirect(request.controller + ".show", AdminPub.getLoggedUserInstitution().getUser().getId());
	}
	...
	public static void show(String id) throws Exception {
		if (Utils.validateUserSession(id)) {
			...
			User object = User.find(
					"id = " + id + " and institutionId = " + AdminPub.getLoggedUserInstitution().getInstitution().getId())
					.first();
